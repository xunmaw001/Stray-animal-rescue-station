    ...
    */
    ...
    public R save(@RequestBody QiuzhuEntity qiuzhu, HttpServletRequest request){
        ...
        Wrapper<QiuzhuEntity> queryWrapper = new EntityWrapper<QiuzhuEntity>()
            ...
            .eq("liulangdongwu_types", qiuzhu.getLiulangdongwuTypes())
            ;
...
//                            qiuzhuEntity.setQiuzhuName(data.get(0));                    //动物昵称 要改的
//                            qiuzhuEntity.setLiulangdongwuTypes(Integer.valueOf(data.get(0)));   //动物品种 要改的
//                            qiuzhuEntity.setQiuzhuPhoto("");//照片
//                            qiuzhuEntity.setQiuzhuContent("");//照片
