...
public class LingyangView extends LingyangEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 审核状态的值
		*/
		private String lingyangYesnoValue;
	...
	public LingyangView(LingyangEntity lingyangEntity) {
		try {
			...
			* 获取： 审核状态的值
			*/
			public String getLingyangYesnoValue() {
				return lingyangYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setLingyangYesnoValue(String lingyangYesnoValue) {
				this.lingyangYesnoValue = lingyangYesnoValue;
			}
