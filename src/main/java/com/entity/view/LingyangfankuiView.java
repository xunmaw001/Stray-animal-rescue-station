...
public class LingyangfankuiView extends LingyangfankuiEntity implements Serializable {
	...
	public LingyangfankuiView() {

	}

	public LingyangfankuiView(LingyangfankuiEntity lingyangfankuiEntity) {
		try {
			BeanUtils.copyProperties(this, lingyangfankuiEntity);
