  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='领养需求' prop="yonghuLingyang">
               <el-input v-model="ruleForm.yonghuLingyang"  placeholder='领养需求' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuLingyang)&& 'yonghu'==this.flag){
                             this.$message.error('领养需求不能为空');
                             return
                         }
