...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    lingyangYesnoTypes: false,
                    lingyangYesnoText: false,
                },
                ruleForm: {
                    liulangdongwuId: '',
                    yonghuId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=lingyang_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.lingyangYesnoTypesOptions = data.data.list;
                    }
                });
