    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="动物昵称" prop="liulangdongwuName">
                        <el-input v-model="liulangdongwuForm.liulangdongwuName"
                                  placeholder="动物昵称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="动物品种" prop="liulangdongwuValue">
                        <el-input v-model="liulangdongwuForm.liulangdongwuValue"
                                  placeholder="动物品种" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24" v-if="sessionTable !='liulangdongwu' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="动物性别" prop="liulangdongwuSexValue">
                        <el-input v-model="liulangdongwuForm.liulangdongwuSexValue"
                                  placeholder="动物性别" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="健康状况" prop="liulangdongwuJiangkang">
                        <el-input v-model="liulangdongwuForm.liulangdongwuJiangkang"
                                  placeholder="健康状况" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="疫苗情况" prop="liulangdongwuShizhang">
                        <el-input v-model="liulangdongwuForm.liulangdongwuShizhang"
                                  placeholder="疫苗情况" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="绝育情况" prop="liulangdongwuJueyu">
                        <el-input v-model="liulangdongwuForm.liulangdongwuJueyu"
                                  placeholder="绝育情况" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='liulangdongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="领养状态" prop="lingyangStatusValue">
                        <el-input v-model="liulangdongwuForm.lingyangStatusValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="领养需求" prop="yonghuLingyang">
                        <el-input v-model="yonghuForm.yonghuLingyang"
                                  placeholder="领养需求" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="领养需求" prop="yonghuLingyang">
                            <el-input v-model="ruleForm.yonghuLingyang"
                                      placeholder="领养需求" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="lingyangfankuiName">
                       <el-input v-model="ruleForm.lingyangfankuiName"
                                 placeholder="标题" clearable  :readonly="ro.lingyangfankuiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="标题" prop="lingyangfankuiName">
                           <el-input v-model="ruleForm.lingyangfankuiName"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.lingyangfankuiPhoto" label="动物图片" prop="lingyangfankuiPhoto">
                        <file-upload
                            tip="点击上传动物图片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.lingyangfankuiPhoto?ruleForm.lingyangfankuiPhoto:''"
                            @change="lingyangfankuiPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lingyangfankuiPhoto" label="动物图片" prop="lingyangfankuiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.lingyangfankuiPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.lingyangfankuiVideo" label="视频" prop="lingyangfankuiVideo">
                        <file-upload
                            tip="点击上传视频"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.lingyangfankuiVideo?ruleForm.lingyangfankuiVideo:''"
                            @change="lingyangfankuiVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lingyangfankuiVideo" label="视频" prop="lingyangfankuiVideo">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.lingyangfankuiVideo.split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="lingyangfankuiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.lingyangfankuiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lingyangfankuiContent" label="详情" prop="lingyangfankuiContent">
                            <span v-html="ruleForm.lingyangfankuiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    lingyangfankuiName: false,
                    lingyangfankuiPhoto: false,
                    lingyangfankuiVideo: false,
                    lingyangfankuiContent: false,
                },
                ruleForm: {
                    liulangdongwuId: '',
                    yonghuId: '',
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`lingyangfankui/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.lingyangfankuiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            lingyangfankuiPhotoUploadChange(fileUrls){
                this.ruleForm.lingyangfankuiPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
            lingyangfankuiVideoUploadChange(fileUrls){
                this.ruleForm.lingyangfankuiVideo = fileUrls;
                this.addEditUploadStyleChange()
            },
