               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="动物昵称" prop="qiuzhuName">
                       <el-input v-model="ruleForm.qiuzhuName"
                                 placeholder="动物昵称" clearable  :readonly="ro.qiuzhuName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.qiuzhuPhoto" label="动物图片" prop="qiuzhuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.qiuzhuPhoto?ruleForm.qiuzhuPhoto:''"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="求助详情" prop="qiuzhuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.qiuzhuContent" label="求助详情" prop="qiuzhuContent">
